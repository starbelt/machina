"""
tests/test_blocks_phase3c.py
-----------------------------
Phase 3c unit tests for Layer 2 geometry functions and cost.smooth_coverage.
...
TestRegistryCounts       -- registry count and domain checks
"""
